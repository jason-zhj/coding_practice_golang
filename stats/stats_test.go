...
// ref: https://github.com/golang/perf/blob/40a54f11e90963acb1c431127af77c095654c32d/internal/stats/tdist.go#L10
...
func TDistCDF(df float64, val float64) float64 {
	if val == 0 {
		return 0.5
	}
	if val > 0 {
		return 1 - 0.5*mathBetaInc(df/(df+val*val), df/2, 0.5)
	}
	return 0.5*mathBetaInc(df/(df+val*val), df/2, 0.5)
}

func TestStats(t *testing.T) {
	fmt.Println(TDistCDF(1,31.821))
}
